...
- **Search History:** 
View history of all your product searches
- **Shopping Cart**: 
...
_**Since this project was predominantly created to showcase Python-database connectivity, the scraping program was designed to be a non-automated one-time process. Hence, in step 3, we ask you to run the CSVtoMYSQL.py program, which adds all the pre-scraped product details to your local MySQL database**_ 
